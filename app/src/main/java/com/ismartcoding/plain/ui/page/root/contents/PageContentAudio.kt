...
fun PageContentAudio(
    audioState: AudioPageState, audioVM: AudioViewModel, audioPlaylistVM: AudioPlaylistViewModel,
    tagsVM: TagsViewModel, mediaFoldersVM: MediaFoldersViewModel, castVM: CastViewModel, paddingValues: PaddingValues,
) {
    ...
    PageContentAudioEffects(audioState, audioVM, audioPlaylistVM, tagsVM, mediaFoldersVM)
    ...
    Box(modifier = Modifier.fillMaxSize().padding(top = paddingValues.calculateTopPadding())) {
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            PageContentAudioList(pagerState, scrollBehavior, dragSelectState, itemsState, audioVM, audioPlaylistVM,
